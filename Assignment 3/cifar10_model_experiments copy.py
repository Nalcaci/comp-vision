...
def train_and_validate(model, train_loader, val_loader, criterion, optimizer, scheduler, epochs, device):
    ...
    for epoch in range(epochs):
        ...
        scheduler.step(val_loss)  # Reduce LR when validation loss stops improving
...
def main():
    ...
    history_variant2 = train_and_validate(model_variant2, train_loader, val_loader, criterion, optimizer, scheduler, epochs, device)
